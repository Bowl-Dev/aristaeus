...
// Validation schemas
const VALID_BOWL_SIZES = [250, 320, 480] as const;
const MIN_QUANTITY_GRAMS = 10;

const createOrderSchema = z.object({
  bowlSize: z.number().refine((val) => VALID_BOWL_SIZES.includes(val as 250 | 320 | 480), {
    message: 'Bowl size must be 250, 320, or 480 grams',
  }),
